                    ...
                    <div id="primary" class="content-area col-md-8">
                        <div id="content" class="site-content">
                            ...
                            <div class="site-event">
                                <h2 class="event-title">Posuere Tincidunt Garcu Sodales</h2>
                                <div class="event-date">
                                    <a href="#">
                                        <time class="published" datetime="2019-12-22"
                                            title="December 11, 2019 - 21:12 pm">Dec<span
                                                class="date">11</span>2019</time>
                                    </a>
                                </div><!-- event-date -->
                                <figure class="event-img">
                                    <img src="images/content/event-img-01.jpg" alt="">
                                </figure>
                                <div class="row">
                                    <div class="col-md-5">
                                            ...
                                            <table>
                                                <tbody>
                                                    <tr>
                                                        <th> Start: </th>
                                                        <td>
                                                            <abbr class="" title="2019-12-10">Dec 10 @ 8:00 am</abbr>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <th> End: </th>
                                                        <td>
                                                            <abbr class="" title="2019-12-10">Dec 11 @ 5:00 pm</abbr>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <th> Cost: </th>
                                                        <td class="event-cost"> $38 </td>
                                                    </tr>

                                                    <tr>
                                                        <th>Event Categories:</th>
                                                        <td class="event-cat">
                                                            <a href="#" rel="tag">Cooking Moms</a>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <th>Event Tags:</th>
                                                        <td class="event-tags">
                                                            <a href="#" rel="tag">magic kitchen</a>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <th> Website: </th>
                                                        <td class="event-url">
                                                            <a href="#">Visit Event Website</a>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                            <h3>Venue</h3>
                                            <p>Ganolia Building<br>Lapangan Serak Tenggara Jalan Teratai No. 11, Cimahi.
                                                Jawa Barat</p>
                                            <p><a href="#"><em>view google map</em></a></p>
                                    ...
                                    <div class="col-md-7">
                                        <div class="event-desc">
                                            ...
                                            <p>Sed sed sapien sed massa pharetra feugiat. Sed leo mi, vulputate et augue
                                                tempus, eleifend varius mauris. Aliquam dui erat, imperdiet mollis ante
                                                non, pharetra finibus diam. Nulla non ligula tempor, varius enim id,
                                                tincidunt nibh. Mauris sit amet dictum eros. Aenean massa justo,
                                                tincidunt sed sapien ut, mollis aliquam felis. In consectetur leo eros,
                                                vitae tincidunt ex feugiat at. Vestibulum vel fringilla turpis, ac
                                                dictum dolor.</p>
                                            <p><strong>Schedule</strong></p>
                                            <ul>
                                                <li>08:00 - 09:00 Opening.</li>
                                                <li>09:00 - 10:00 Session 1</li>
                                                <li>12:00 - 13:00 Break</li>
                                                <li>13:00 - 16:00 Session 2</li>
                                                <li>16:00 - 17:00 Photo Session</li>
                                            </ul>
                                            <button class="btn btn-primary"><i
                                                    class="fas fa-ticket-alt">&nbsp;</i>Register Now</button>
                                        </div>
                                    </div><!-- end col -->
                                </div><!-- end row -->
                            </div><!-- event-post -->
