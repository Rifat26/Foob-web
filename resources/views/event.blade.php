                ...
                <div id="content" class="site-content">
                    ...
                    <div class="event-bar">
                        <form>
                            <div class="form-row">
                                <div class="col-md-4">
                                    <label for="dateEvent">Event From</label>
                                    <input data-toggle="datepicker" type="text" class="form-control" id="dateEvent"
                                        placeholder="Date">
                                </div><!-- end col -->
                                ...
                                <div class="col-md-4">
                                    <button class="btn btn-outline-primary">Find Events</button>
                                </div><!-- end col -->
                            </div><!-- end form-row -->
                        </form>
                    </div><!-- event-bar -->
                        ...
                        <div class="event-date">
                            ...
                            <a href="#">
                                <time class="published" datetime="2019-12-22"
                                    title="December 22, 2019 - 21:12 pm">Dec<span class="date">22</span>2019</time>
                            </a>
                        </div><!-- event-date -->
                        <figure class="event-img">
                            <img src={{$item->events_img}} alt="">
                        </figure>
                        <h2 class="event-title"><a href="#">{{$item->events_title}}</a></h2>
                        <div class="row">
                            <div class="col">
                                <p>{{$item->events_address}}</p>
                                <p>{{$item->events_start_date}} &mdash; {{$item->events_end_date}}</p>
                            </div>
                            <div class="col">
                                <a href="#" class="btn btn-primary float-right"><i
                                        class="fas fa-ticket-alt">&nbsp;</i>Buy Ticket</a>
                            </div>
                        </div><!-- end row -->
                    </div><!-- event-post -->
                    @endforeach
                    ...
                    {{-- <div class="event-post"> 
                        ...
                        <figure class="event-img">
                            <img src="images/content/event-img-02.jpg" alt="">
                        </figure>
                        <h2 class="event-title"><a href="#">Posuere Tincidunt Garcu Sodales</a></h2>
                        <div class="row">
                            <div class="col">
                                <p>Ganolia Building</p>
                                <p>December 11 &mdash; December 22</p>
                            </div>
                            <div class="col">
                                <a href="#" class="btn btn-primary float-right"><i
                                        class="fas fa-ticket-alt">&nbsp;</i>Buy Ticket</a>
                    ...
                    <div class="event-post">
                        ...
                        <figure class="event-img">
                            <img src="images/content/event-img-03.jpg" alt="">
                        </figure>
                        <h2 class="event-title"><a href="#">Posuere Tincidunt Garcu Sodales</a></h2>
                        <div class="row">
                            <div class="col">
                    ...
                    <div class="event-post">
                        ...
                        <figure class="event-img">
                            <img src="images/content/event-img-04.jpg" alt="">
                        </figure>
                        <h2 class="event-title"><a href="#">Posuere Tincidunt Garcu Sodales</a></h2>
                        <div class="row">
                            <div class="col">
                    ...
                    <div class="event-post">
                        ...
                        <figure class="event-img">
                            <img src="images/content/event-img-05.jpg" alt="">
                        </figure>
                        <h2 class="event-title"><a href="#">Posuere Tincidunt Garcu Sodales</a></h2>
                        <div class="row">
                            <div class="col">
            ...
            <div id="secondary" class="col-md-4">
                ...
                <div class="widget">
                    ...
                    <div class="tagcloud"><a href="#">food</a><a href="#">ingredients</a><a href="#">chef</a><a
                            href="#">kitchen</a><a href="#">vegetable</a><a href="#">cake</a><a href="#">beverage</a><a
                            href="#">tips</a><a href="#">nutrition</a><a href="#">tools</a></div>
                </div><!-- end widget -->
